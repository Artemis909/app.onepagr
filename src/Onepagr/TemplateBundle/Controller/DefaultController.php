...
class DefaultController extends Controller {
	...
	public function indexAction($name = null) {
		...
		$subdomain = $this->extractSubdomains($_SERVER['HTTP_HOST']);
	...
	public function createAction($name) {
		...
		$helper->setIndexDir($this->get('kernel')->getRootDir() . '/../web/indexes/');
		...
		if($domain) {
		$this->container->get('onepagr.page.response_listener')->setSave(true);
		$this->container->get('onepagr.page.response_listener')->setDomain($domain);
		$this->container->get('onepagr.page.response_listener')->setContentHelper($helper);
		
		}
		// $this->container->get('templating')->setAssetUrl();
